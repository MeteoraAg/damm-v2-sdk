...
/**
 * Gets the total trading fee from an included fee amount.
 * @param poolFees - The pool fees.
...
/**
 * Gets the total trading fee from an excluded fee amount.
 * @param poolFees - The pool fees.
 * @param currentPoint - The current point.
 * @param activationPoint - The activation point.
...
/**
 * Splits the fees into protocol, referral, and partner fees.
 * @param poolFees - The pool fees.
