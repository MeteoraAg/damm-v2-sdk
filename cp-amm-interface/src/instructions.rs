...
impl CpAmmProgramIx {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        match maybe_discm {
            ...
            SET_POOL_STATUS_IX_DISCM => Ok(Self::SetPoolStatus(SetPoolStatusIxArgs::deserialize(
                &mut reader,
            )?)),
            CLAIM_PROTOCOL_FEE_IX_DISCM => Ok(Self::ClaimProtocolFee),
            CLAIM_PARTNER_FEE_IX_DISCM => Ok(Self::ClaimPartnerFee(
            ...
            INITIALIZE_CUSTOMIZABLE_POOL_IX_DISCM => Ok(Self::InitializeCustomizablePool(
            ...
            LOCK_POSITION_IX_DISCM => Ok(Self::LockPosition(LockPositionIxArgs::deserialize(
                &mut reader,
            )?)),
            REFRESH_VESTING_IX_DISCM => Ok(Self::RefreshVesting),
            PERMANENT_LOCK_POSITION_IX_DISCM => Ok(Self::PermanentLockPosition(
...
pub fn create_token_badge_ix(keys: CreateTokenBadgeKeys) -> std::io::Result<Instruction> {
    create_token_badge_ix_with_program_id(crate::ID, keys)
}
...
pub fn create_token_badge_invoke(accounts: CreateTokenBadgeAccounts<'_, '_>) -> ProgramResult {
    create_token_badge_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn create_token_badge_invoke_signed(
    ...
    create_token_badge_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
...
impl<'info> From<SetPoolStatusAccounts<'_, 'info>>
    for [AccountInfo<'info>; SET_POOL_STATUS_IX_ACCOUNTS_LEN]
{
...
impl<'info> From<ClaimPartnerFeeAccounts<'_, 'info>>
    for [AccountInfo<'info>; CLAIM_PARTNER_FEE_IX_ACCOUNTS_LEN]
{
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN]>
...
impl InitializeCustomizablePoolIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(InitializeCustomizablePoolIxArgs::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
pub fn create_position_ix(keys: CreatePositionKeys) -> std::io::Result<Instruction> {
    create_position_ix_with_program_id(crate::ID, keys)
}
pub fn create_position_invoke_with_program_id(
    ...
    let ix = create_position_ix_with_program_id(program_id, keys)?;
    invoke_instruction(&ix, accounts)
}
pub fn create_position_invoke(accounts: CreatePositionAccounts<'_, '_>) -> ProgramResult {
    create_position_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn create_position_invoke_signed(
    ...
    create_position_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
...
impl<'info> From<ClaimPositionFeeAccounts<'_, 'info>>
    for [AccountInfo<'info>; CLAIM_POSITION_FEE_IX_ACCOUNTS_LEN]
{
...
pub fn claim_position_fee_ix(keys: ClaimPositionFeeKeys) -> std::io::Result<Instruction> {
    claim_position_fee_ix_with_program_id(crate::ID, keys)
}
pub fn claim_position_fee_invoke_with_program_id(
    ...
    let ix = claim_position_fee_ix_with_program_id(program_id, keys)?;
    invoke_instruction(&ix, accounts)
}
pub fn claim_position_fee_invoke(accounts: ClaimPositionFeeAccounts<'_, '_>) -> ProgramResult {
    claim_position_fee_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn claim_position_fee_invoke_signed(
    ...
    claim_position_fee_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
...
impl<'info> From<RefreshVestingAccounts<'_, 'info>>
    for [AccountInfo<'info>; REFRESH_VESTING_IX_ACCOUNTS_LEN]
{
